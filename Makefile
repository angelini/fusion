...
build: internal/pb/definitions.pb.go internal/pb/definitions_grpc.pb.go
	$(KO) build --base-import-paths --push=false --tarball /tmp/fusion.tar.gz github.com/angelini/fusion
